...
<nav class="w3-sidenav w3-collapse w3-theme-l5 w3-animate-left" style="z-index:3;width:250px;margin-top:51px;" id="mySidenav">
  ...
  <h4><b>Menu</b></h4>
  <a href="#" class="w3-hover-black">News 1</a>
  <a href="#" class="w3-hover-black">News 2</a>
  <a href="#" class="w3-hover-black">News 3</a>
  <a href="#" class="w3-hover-black">News 4</a>
</nav>
...
Blablabla.</p>
    ...
    <div class="w3-third w3-container">
      <p class="w3-border w3-padding-large w3-padding-32 w3-center">UPCOMING EVENT</p>
      <p class="w3-border w3-padding-large w3-padding-64 w3-center">UPCOMING EVENT</p>
    </div>
  </div>
