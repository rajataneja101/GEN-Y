...
.w3-sidenav a,.w3-sidenav h4{padding:14px; font-size: 20px}
.w3-navbar a{padding-top:8px !important;padding-bottom:8px !important;}
</style>
...
<div class="w3-top">
 <ul class="w3-navbar w3-theme-d2 w3-left-align w3-large">
  ...
  <li><a href="/index" class="w3-teal"><i class="fa fa-home w3-margin-right"></i>GEN-Y</a></li>
...
<div class="w3-new">
    <img src="/geny/akash2.jpg" alt="akash" style="width:35%" class="w3-circle w3-hover-opacity">
  <h3>Akash Mishra</h3>
  <p>President</p>
</div>

<div class="w3-new">
  <img src="/geny/chappan.jpg" alt="chappan" style="width:35%" class="w3-circle w3-hover-opacity">
  <h3>Iyappan</h3>
  <p>Vice-President</p>
</div>

    <div class="w3-new">
  <img src="/geny/rajat_1.jpg" alt="rajat" style="width:35%" class="w3-circle w3-hover-opacity">
  <h3>Rajat Taneja</h3>
  <p>Joint Vice President</p>
</div>
<div class="w3-new">
  <img src="/geny/iyer.jpg" alt="iyer" style="width:35%" class="w3-circle w3-hover-opacity">
  <h3>Abhishek Iyer</h3>
  <p>Secretary</p>
</div>
    ...
    <div class="w3-new">
  <img src="/geny/garvit2.jpg" alt="garvit" style="width:35%" class="w3-circle w3-hover-opacity">
  <h3>Garvit Kameshra</h3>
  <p>Vice-Sec</p>
</div>
     <p> ------------------------------------------------------------------------------------------------------------------------
    </p>
...
<div class="w3-new">
 ...
 <footer class="w3-container w3-padding-16 w3-theme-d1 w3-center">
  <h4>Follow Us</h4>
  <a class="w3-btn-floating w3-teal" href="https://www.facebook.com" title="Facebook" ><i class="fa fa-facebook"></i></a>
